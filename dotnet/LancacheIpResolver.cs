namespace LancachePrefill.Common
{
    ...
    public static class LancacheIpResolver
    {
        ...
        private static async Task<DetectedServer> DetectLancacheServerAsync(string cdnUrl)
        {
            ...
            {
                possibleLancacheUrls.Add(defaultGateway.ToString());
            }
        ...
        /// <summary>
        /// Gets the default gateway IP from the container's network interface.
        /// In Docker, this will be the bridge network gateway (e.g., 172.17.0.1).
        /// </summary>
